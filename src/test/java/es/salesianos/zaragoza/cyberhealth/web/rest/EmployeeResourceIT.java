...
import es.salesianos.zaragoza.cyberhealth.repository.EmployeeRepository;
...
public class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).surname(DEFAULT_SURNAME).department(DEFAULT_DEPARTMENT).age(DEFAULT_AGE);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).surname(UPDATED_SURNAME).department(UPDATED_DEPARTMENT).age(UPDATED_AGE);
        return employee;
    }
    ...
    public void updateEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).surname(UPDATED_SURNAME).department(UPDATED_DEPARTMENT).age(UPDATED_AGE);
