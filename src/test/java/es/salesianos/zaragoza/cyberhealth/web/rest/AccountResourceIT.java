...
import static es.salesianos.zaragoza.cyberhealth.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.salesianos.zaragoza.cyberhealth.Covid19TesterApp;
import es.salesianos.zaragoza.cyberhealth.config.Constants;
import es.salesianos.zaragoza.cyberhealth.domain.User;
import es.salesianos.zaragoza.cyberhealth.repository.AuthorityRepository;
import es.salesianos.zaragoza.cyberhealth.repository.UserRepository;
import es.salesianos.zaragoza.cyberhealth.security.AuthoritiesConstants;
import es.salesianos.zaragoza.cyberhealth.service.UserService;
import es.salesianos.zaragoza.cyberhealth.service.dto.PasswordChangeDTO;
import es.salesianos.zaragoza.cyberhealth.service.dto.UserDTO;
import es.salesianos.zaragoza.cyberhealth.web.rest.vm.KeyAndPasswordVM;
import es.salesianos.zaragoza.cyberhealth.web.rest.vm.ManagedUserVM;
