...
import static es.salesianos.zaragoza.cyberhealth.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import es.salesianos.zaragoza.cyberhealth.config.audit.AuditEventConverter;
import es.salesianos.zaragoza.cyberhealth.domain.PersistentAuditEvent;
